...
df_without = pd.read_pickle('data_process/conclusion/sample/hedonic_full_data.pkl')
df_without = df_without.dropna()

# variable setting
df_without['log_per_Pr'] = np.log(df_without['per_Pr'])
...
X = sm.add_constant(df_without[independent_part])
Y = df_without['log_per_Pr']
...
#######################################################################################################################
# save output
vif.to_excel('data_process/conclusion/regression_result/full_without_interactionterm_regression_ols_vif.xlsx')

df_output.to_excel('data_process/conclusion/regression_result/full_without_interactionterm_regression_ols_results.xlsx')
