...
y = df_train.iloc[:, 0:1]  # per_Price (면적당 가격)을 종속변수로 입력
...
rfr_outcome.to_excel('data_process/conclusion/regression_result/rfr_full_test_with_dummy.xlsx')
sum_variable_important.to_excel('data_process/conclusion/regression_result/rfr_full_test_featureselection_withdummy.xlsx')