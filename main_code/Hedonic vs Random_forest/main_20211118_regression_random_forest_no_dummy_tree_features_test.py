...
rfr_outcome.to_excel('data_process/conclusion/regression_result/rfr_with_lat_long_test_features_trees.xlsx')
sum_variable_important.to_excel('data_process/conclusion/regression_result/rfr_lat_long_test_featureselection_trees_features.xlsx')
