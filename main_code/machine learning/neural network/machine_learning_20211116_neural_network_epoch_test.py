...
########################################################################################################################
    ...
    r = model.fit(X_train, y_train, validation_data=(X_valid, Y_valid), batch_size=10, epochs=150)
...
########################################################################################################################
    ...
    r = model.fit(X_train, y_train, validation_data=(X_valid, Y_valid), batch_size=10, epochs=200)
...
nn_outcome.to_excel('data_process/conclusion/regression_result/nn_results_nomalization.xlsx')